...
class AQ_Generic_Page_Block extends AQ_Block {
  ...
  function __construct() {
    $block_options = array(
      ...
      'block_description' => 'Generic page with Bg'
    );

    //create the block
    parent::__construct('aq_generic_page_block', $block_options);
  }//end construct
  ...
  <section class="main-section-with-bg" <?php if($bg_image) { echo 'style="background-image:url('.$bg_image.')"';}?> >
    <div class="row">
      <section class="container full-img-bg generic-page-container">
        <div class="trans-bg-dark col-md-10 col-md-offset-1">
          <?php
            ...
            if( $block1_title ){
              ...
              // echo '    <div class="row">';
              // echo '      <div class="col-xs-12 col-md-12"><h4>' . htmlspecialchars_decode($block1_title) . '</h4></div>';
              // echo '    </div>';
              echo '    <div class="row">';
              echo '      <div class="wide-content col-md-6">';
              if( $block1_video_id ){
